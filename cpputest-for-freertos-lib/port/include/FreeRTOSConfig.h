...
#ifndef CPPUTEST_FOR_FREERTOS_LIB_FREE_RTOS_CONFIG_H
#define CPPUTEST_FOR_FREERTOS_LIB_FREE_RTOS_CONFIG_H
...
#endif //CPPUTEST_FOR_FREERTOS_LIB_FREE_RTOS_CONFIG_H
